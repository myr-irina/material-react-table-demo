...
import AmountsTable from '../layout-collapsed-table-project/amounts-table';

import { numberWithSpaces, MONTHS, HEADER_MONTHS } from '../../../utils/utils';

function LayoutCollapsedTableProjectDDS({ data, title, isLoading }) {
...
export default LayoutCollapsedTableProjectDDS;
